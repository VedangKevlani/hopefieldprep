    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="max-w-5xl mx-auto px-4 mb-4 sticky top-4 z-10 bg-white shadow-md rounded-xl py-3 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button className="px-3 py-2 bg-white border rounded" onClick={zoomOut}>
            -
          </button>
          <button className="px-3 py-2 bg-white border rounded" onClick={resetZoom}>
            100%
          </button>
          <button className="px-3 py-2 bg-white border rounded" onClick={zoomIn}>
            +
          </button>
